...
public class LanguageModelsEstimatorTest {
	...
	public void testCreateLmWordLangOrder1() {
		...
		String trainFilePathShort = "data/train/train-"; 	// Chaine contenant la premi�re partie du chemin vers le fichier
		String lmFilePathShort = "lm/unigram-train-"; 		// Chaine contenant la premi�re partie du chemin vers le fichier qui sera cr��
		int order = 1; 										// Le ngram cr�� sera d'ordre 1
		NgramCounts NgramCounts;
		String configFile = ""; 							// La variable servira � contenir le chemin des fichiers lm pour le fichier de conf
		...
		MiscUtil.writeFile(configFile, "lm/fichConfig_unigram.txt", false); // on place notre chaine de caract�re configFile dans notre fichier de configuration
	...
	public void testCreateLmWordLangOrder2() {
		...
		String trainFilePathShort = "data/train/train-"; 	// Chaine contenant la premi�re partie du chemin vers le fichier
		String lmFilePathShort = "lm/bigram-train-"; 		// Chaine contenant la premi�re partie du chemin vers le fichier qui sera cr��
		int order = 2; 										// Le ngram cr�� sera d'ordre 1
		NgramCounts NgramCounts;
		String configFile = ""; 							// La variable servira � contenir le chemin des fichiers lm pour le fichier de conf
		...
		MiscUtil.writeFile(configFile, "lm/fichConfig_bigram.txt", false); // on place notre chaine de caract�re configFile dans notre fichier de configuration
